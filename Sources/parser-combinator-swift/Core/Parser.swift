...
public class Parser<Input, Output> where Input: Collection {
    ...
    private final let parseFunction: ParseFunction
    ...
    public final func parse(_ input: Input, _ index: Input.Index) throws -> ParseResult<Input, Output> {
    ...
    public final func flatMap<B>(_ tranform: @escaping (Output) throws -> Parser<Input, B>) -> Parser<Input, B> {
    ...
    public final func map<B>(_ transform: @escaping (Output) throws -> B) -> Parser<Input, B> {
        Parser<Input, B> { input, index in
    ...
    public final func filter(_ pred: @escaping (Output) -> Bool) -> Parser<Input, Output> {
